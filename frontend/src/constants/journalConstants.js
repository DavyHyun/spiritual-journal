...
export const JOURNAL_GROUP_UPDATE_REQUEST = "JOURNAL_GROUP_UPDATE_REQUEST";
export const JOURNAL_GROUP_UPDATE_SUCCESS = "JOURNAL_GROUP_UPDATE_SUCCESS";
export const JOURNAL_GROUP_UPDATE_FAIL = "JOURNAL_GROUP_UPDATE_FAIL";